defmodule DevelopmentWeb.Components.Tooltip do
  @moduledoc """
  A Tooltip DevelopmentWeb.Components.Tooltip module for use in Phoenix applications.
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tooltip
  ...
  attr :class, :any, default: "", doc: "Additional CSS classes for wrapper"
  ...
  slot :content, required: false, doc: "Custom tooltip content (alternative to text attr)" do
    attr :class, :any, doc: "Additional CSS classes for this content"
  end
