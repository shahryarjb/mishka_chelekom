defmodule DevelopmentWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `DevelopmentWeb.Components.Carousel`
  project.
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/carousel
  ...
  import DevelopmentWeb.Components.Image, only: [image: 1]
