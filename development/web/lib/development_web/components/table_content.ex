defmodule DevelopmentWeb.Components.TableContent do
  @moduledoc """
  `DevelopmentWeb.Components.TableContent` is a component module designed to create flexible and dynamic
